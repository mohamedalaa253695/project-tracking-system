...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      logoPath: "".concat(window.location.origin, "/images/logo.svg")
    };
  },
  created: function created() {
    var _this = this;

    console.log("".concat(window.location.origin, "/images/logo.svg"));
    this.logoPath = localStorage.getItem("logo") || "".concat(window.location.origin, "/images/logo.svg");
    Event.$on("switched", function (theme) {
      return theme == "theme-light" ? (_this.logoPath = "".concat(window.location.origin, "/images/logo.svg")) && localStorage.setItem("logo", "".concat(window.location.origin, "/images/logo.svg")) : (_this.logoPath = "".concat(window.location.origin, "/images/logo-light.svg")) && localStorage.setItem("logo", "".concat(window.location.origin, "/images/logo-light.svg"));
    });
  }
});
...
/* harmony import */ var _ProjectTrackingForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProjectTrackingForm */ "./resources/js/components/ProjectTrackingForm.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      form: new _ProjectTrackingForm__WEBPACK_IMPORTED_MODULE_1__["default"]({
        title: "",
        description: "",
        tasks: [{
          body: ""
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.form.submit("/project/store").then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    themeSwitcherHandler: function themeSwitcherHandler() {
      // return this.selectedTheme;
      Event.$emit("switched", this.selectedTheme);
...
var render = function () {
  ...
  var _c = _vm._self._c || _h
  return _c("h1", [
    _c("a", { staticClass: "navbar-brand", attrs: { href: "/projects" } }, [
      _c("img", {
        staticClass: "w-36",
...
var render = function () {
  ...
  return _c(
    "modal",
    {
      attrs: {
        name: "new-project",
        classes: "p-10 bg-card rounded-lg bg-black",
        height: "auto",
      },
    },
    [
  ...
  return _c(
    ...
    _vm._l(_vm.themes, function (color, theme) {
      return _c("button", {
        ...
        on: {
          click: function ($event) {
            ;(_vm.selectedTheme = theme) && _vm.themeSwitcherHandler()
          },
        },
      })
    }),
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('logo', __webpack_require__(/*! ./components/Logo.vue */ "./resources/js/components/Logo.vue")["default"]);
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('dropdown', __webpack_require__(/*! ./components/Dropdown.vue */ "./resources/js/components/Dropdown.vue")["default"]); //  Vue.component('new-project-modal', require('./components/NewProjectModal.vue').default);
...
/***/ "./resources/js/components/ProjectTrackingForm.js":
/*!********************************************************!*\
  !*** ./resources/js/components/ProjectTrackingForm.js ***!
  \********************************************************/
/*! exports provided: default */
...
var ProjectTrackingForm = /*#__PURE__*/function () {
  function ProjectTrackingForm(data) {
    _classCallCheck(this, ProjectTrackingForm);
  ...
  _createClass(ProjectTrackingForm, [{
    key: "data",
    value: function data() {
      var _this = this;
  ...
  return ProjectTrackingForm;
}();

/* harmony default export */ __webpack_exports__["default"] = (ProjectTrackingForm);
...
__webpack_require__(/*! /srv/http/birdboard/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /srv/http/birdboard/resources/sass/app.scss */"./resources/sass/app.scss");
